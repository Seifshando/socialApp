...
import { UserContext } from '../../Hamada/UserContext.jsx'
...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
    ...
    {userLogin !== null ? <>      <button type="button" className="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <span className="sr-only">Open user menu</span>
        <img className="w-8 h-8 rounded-full size-[36px]" src={data?.photo} alt="user photo" />
      </button>
      ...
      : <>      
        <li>
          <Link className='text-white pe-4' to="/login">Login</Link>
          <Link className='text-white' to="/register">Reigster</Link>
        </li>
        <li></li>
