...
import style from './UploadProfilePhoto.jsx'
...
const form = useForm({
  ...
  function uploadPhoto(value){
    ...
    .catch((err) => {
      console.log(err);
      toast.error("Can't upload this photo !");
    })
  }
      ...
      <div className="relative p-4 w-full max-w-md max-h-full">
          <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
              ...
              <div className="p-4 md:p-5">
                  <form onSubmit={handleSubmit(uploadPhoto)} className="space-y-4" action="#">
                      <div>
                          <label htmlFor="photo" className=" text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center cursor-pointer w-full block">
                            <i class="fa-solid fa-image fa-2xl"></i>
                          </label>
                          <input type="file"  id="photo" {...register('photo')} className="hidden bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
                      </div>
